...
from aqmodels import Model, Variable, Environment, Vtype, Solution
...
def test_simple_solution_print(model: tuple[Model, tuple[Variable, ...]]):
    ...
    with m.environment:
        sol = Solution.from_dicts(
            [
                {b0: 0, b1: 1, s0: -1, s1: 1, i0: -10, i1: 42, r0: -324.12, r1: 100_000_000},
                {b0: 0, b1: 1, s0: -1, s1: 1, i0: -100, i1: 42, r0: -3.12, r1: -10.1},
            ]
        )
    print()
    print(sol.print(max_line_length=20, max_chars_per_var=5, show_metadata="left"))
    print()
    print(sol.print(max_line_length=20, max_chars_per_var=5, show_metadata="right"))
