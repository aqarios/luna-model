...
from luna_model._lm import PyModel, PyPassContext, PySolution, PyTransformationPass
...
class TransformationPass(PyTransformationPass, Generic[Artifact], metaclass=_TransformationPassMeta):
    ...
    def _forward(self, model: PyModel, ctx: PyPassContext) -> tuple[PyModel, Artifact]:
