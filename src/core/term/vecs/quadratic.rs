...
use crate::core::{
    term::types::{
        BiasConstraints, ExpressionResult, IndexConstraints, OneVarTerm, OneVarTermConstruction,
        SizeType,
    },
    QuadraticExpressionBase, QuadraticExpressionBaseInternal, Vtype,
};

pub struct QuadraticExpression<Bias, Index>
where
...
impl<Bias, Index> QuadraticExpressionBase<Bias, Index> for QuadraticExpression<Bias, Index>
where
    Bias: BiasConstraints,
    Index: IndexConstraints,
    Self: QuadraticExpressionBaseInternal<Bias, Index>,
{
...
impl<Bias, Index> QuadraticExpressionBaseInternal<Bias, Index> for QuadraticExpression<Bias, Index>
where
    Bias: BiasConstraints,
    Index: IndexConstraints,
    // Self: QuadraticModelBase<Bias, Index>,
{
    fn default() -> Self {
        Self {
    ...
    fn new_linear(linear_biases: &Vec<Bias>) -> Self {
        Self {
            linear_biases: linear_biases.to_vec(),
            adj: None,
            offset: Bias::default(),
            phantom_index: PhantomData,
        }
    ...
    fn new_linear_single(n: Index) -> Self {
        Self {
            linear_biases: Vec::with_capacity(n.into()),
            adj: None,
            offset: Bias::default(),
            phantom_index: PhantomData,
        }
...
impl<Bias, Index> QuadraticExpression<Bias, Index>
where
    Bias: BiasConstraints,
    Index: IndexConstraints,
{
