...
#[cfg_attr(feature = "lq",      pyclass(unsendable, name = "CqmTranslator", module = "luna_quantum.translator"))]
#[cfg_attr(not(feature = "lq"), pyclass(unsendable, name = "CqmTranslator", module = "aqmodels.translator"))]
