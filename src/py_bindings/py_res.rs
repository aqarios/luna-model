...
/// >>> result.feasible
/// False
#[cfg_attr(not(feature = "lq"), pyclass(unsendable, name = "ResultView", module = "aqmodels._core"))]
#[cfg_attr(feature = "lq", pyclass(unsendable, name = "ResultView", module = "luna_quantum._core"))]
...
/// >>> result.feasible
/// False
#[cfg_attr(not(feature = "lq"), pyclass(unsendable, name = "Result", module = "aqmodels._core"))]
#[cfg_attr(feature = "lq", pyclass(unsendable, name = "Result", module = "luna_quantum._core"))]
#[derive(Deref, DerefMut)]
...
/// [0, -5, 0.28]
/// [1, -4, -0.42]
#[cfg_attr(not(feature = "lq"), pyclass(unsendable, name = "ResultIterator", module = "aqmodels._core"))]
#[cfg_attr(feature = "lq",      pyclass(unsendable, name = "ResultIterator", module = "luna_quantum._core"))]
#[derive(Deref, DerefMut)]
